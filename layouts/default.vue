<template>
  <v-app dark>
    ...
    >
      ...
      <v-spacer />
      <v-toolbar-title  class="mr-15" v-if="signer">Current account: {{currentAddress ? currentAddress : 'No account detected'}}</v-toolbar-title>
      <v-btn
        light
    ...
    async callGreeter() {
      if(this.signer) {
        let tokenContract = new ethers.Contract(
          "0x1Bb3022900e4eb49B1E94Aa265E3E6bae393BD4F",
          greeter.abi,
          this.signer
        );
